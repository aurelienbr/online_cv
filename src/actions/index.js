const TRANSLATIONS = {
  ...
  fr: {
    ...
    "exia.lieu": "Bordeaux, France",
    "exia.description": "Ecole d'ingénieur spécialisation développement"
  },
  ru: {
    "header.home": "прием",
    "header.about": "кстати",
